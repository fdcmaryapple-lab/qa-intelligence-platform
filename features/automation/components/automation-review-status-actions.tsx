...
import { updateAutomationReviewStatusAction } from "@/features/automation/actions";

export function AutomationReviewStatusActions({ scriptId }: { scriptId: string }) {
  ...
  async function setStatus(reviewStatus: "ACCEPTED" | "REJECTED") {
    ...
    const result = await updateAutomationReviewStatusAction({ scriptId, reviewStatus });
