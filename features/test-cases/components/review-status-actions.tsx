...
import { updateReviewStatusAction } from "@/features/test-cases/actions";

export function ReviewStatusActions({ testCaseId }: { testCaseId: string }) {
  ...
  async function setStatus(reviewStatus: "ACCEPTED" | "REJECTED") {
    ...
    const result = await updateReviewStatusAction({ testCaseId, reviewStatus });
